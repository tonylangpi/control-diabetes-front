...
const DetalleEditUsuario = ({detallesUsuarioEdit}) => {
  ...
  return (
    <section  className="flex flex-col items-center justify-center h-auto gap-5  bg-gray-50 p-52" style={{  backgroundImage: `url(${backgroundImageUrl})`, backgroundSize: 'cover'  }} >
