...
const ButtonEditPaciente = ({row, mutate}) => {
    ...
    const gestionarTratamientosPaciente = () => {
        console.log('Gestionando tratamientos del paciente: ', row.getValue("Id_Paciente"))
        router.push(`/Expedientes/${row.getValue("Id_Paciente")}`)
    }
  return (
    <>
      <button
      ...
      <button
        ...
        data-te-placement="top"
        data-te-ripple-color="light"
        title="Gestionar Historial de Tratamientos"
        onClick={gestionarTratamientosPaciente}
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-report-medical" width="24" height="24" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2" /><path d="M9 3m0 2a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v0a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2z" /><path d="M10 14l4 0" /><path d="M12 12l0 4" /></svg>
      </button>
    </>
  );
}
